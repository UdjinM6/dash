...
public:
    ...
    [[nodiscard]] RecalcDiffsResult RecalculateAndRepairDiffs(const CBlockIndex* start_index, const CBlockIndex* stop_index,
                                                              ChainstateManager& chainman, CSpecialTxProcessor& tx_proc,
