    ...
    FuzzedDataProvider fuzzed_data_provider(buffer.data(), buffer.size());
    {
        ...
        if (mtx) {
            ...
            if (in < tx_to.vin.size()) {
                (void)SignatureHash(script_code, tx_to, in, fuzzed_data_provider.ConsumeIntegral<int>(), ConsumeMoney(fuzzed_data_provider), nullptr);
                ...
                if (mtx_precomputed) {
                    ...
                    (void)SignatureHash(script_code, tx_to, in, fuzzed_data_provider.ConsumeIntegral<int>(), ConsumeMoney(fuzzed_data_provider), &precomputed_transaction_data);
                }
            }
        }
    }
