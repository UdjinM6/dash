...
ActiveContext::ActiveContext(ChainstateManager& chainman, CConnman& connman, CDeterministicMNManager& dmnman,
    ...
    qdkgsman{std::make_unique<llmq::CDKGSessionManager>(*llmq_ctx.bls_worker, chainman.ActiveChainstate(), dmnman,
                                                        *llmq_ctx.dkg_debugman, mn_metaman,
                                                        *llmq_ctx.quorum_block_processor, *llmq_ctx.qsnapman,
                                                        &mn_activeman, sporkman, db_params, quorums_watch)},
